...
type StreamItemSkeletonProps = StackProps & {
  variant?: 'vertical' | 'horizontal';
};

export function StreamItemSkeleton({ variant = 'vertical', sx, ...other }: StreamItemSkeletonProps) {
...
export function StreamDetailsSkeleton({ ...other }: StackProps) {
  return (
    <Stack {...other}>
