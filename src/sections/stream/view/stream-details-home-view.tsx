...
import StreamCommentList from '../stream-comment-list';
import StreamCommentForm from '../stream-comment-form';
import StreamDetailsHero from '../stream-details-hero';
    ...
    <>
      ...
      <Container maxWidth={false}>
        <Stack sx={{ maxWidth: 720, mx: 'auto' }}>
          ...
          <StreamCommentList comments={post.comments} />
        </Stack>
      </Container>
    </>
  );
